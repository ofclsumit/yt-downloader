...
export const ERROR_CODES = {
  ...
  COOKIE_NOT_USED: 'COOKIE_NOT_USED',
...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  VIDEO_AGE_RESTRICTED: 'This video is age-restricted and requires account verification.',
  REGION_RESTRICTED: 'This video is geographically restricted and unavailable in the processing region.',
  VIDEO_REGION_RESTRICTED: 'This video is geographically restricted and unavailable in the processing region.',
  ...
  BOT_DETECTION: 'YouTube is requesting bot verification for datacenter IPs. The administrator needs to configure a valid yt-dlp cookie session.',
  LOGIN_REQUIRED: 'YouTube sign-in is required to view this video.',
  PO_TOKEN_REQUIRED: 'YouTube requires bot verification for this request. Please configure a valid session.',
  COOKIE_INVALID: 'The configured YouTube cookie session is invalid or malformed.',
  COOKIE_EXPIRED: 'The YouTube cookie session has expired. Please refresh your cookies.',
  COOKIE_NOT_USED: 'The configured YouTube cookie session could not be applied.',
  EJS_MISSING: 'Failed to extract video data from YouTube. Please try again shortly.',
  JS_RUNTIME_MISSING: 'Failed to extract video data from YouTube. Please try again shortly.',
  FORMAT_ERROR: 'Failed to extract video data from YouTube. Please try again shortly.',
  NETWORK_ERROR: 'YouTube network error or rate limit. Please try again shortly.',
  YTDLP_ERROR: 'Failed to extract video data from YouTube. Please try again shortly.',
